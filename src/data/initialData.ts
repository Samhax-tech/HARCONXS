...
export const INITIAL_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    type: 'ACCOUNT_CREATED',
    category: 'account',
    title: 'Welcome to HARCONXS Atelier',
    message: 'Your member account is active with +150 Loyalty Points credited to your wallet!',
  ...
  },
  {
    ...
    type: 'ORDER_CREATED',
    category: 'orders',
    title: 'Order Confirmed: #HX-90821',
    message: 'We have received your custom order. Total Paid: ₹6,439. Bench fabrication queued.',
    data: { orderNumber: 'HX-90821', total: 6439 },
    isRead: false,
    readAt: null,
  ...
  },
  {
    ...
    category: 'orders',
    title: 'Crafting on Bench: #HX-90821',
    message: 'Your bespoke pieces are currently undergoing micron fiber laser engraving & QA inspection.',
    data: { orderNumber: 'HX-90821', carrier: 'FedEx Express' },
    isRead: true,
    readAt: '2026-08-15T10:00:00Z',
  ...
  },
  {
    ...
    category: 'custom',
    title: 'New Message on Custom Project #REQ-4819',
    message: 'Master Artisan Julian: "I have updated the 3D CAD rendering with the roman numeral coordinates for your approval."',
    data: { requestNumber: 'REQ-4819', senderName: 'Julian (Master Artisan)' },
    isRead: false,
    readAt: null,
    createdAt: '2026-08-16T14:20:00Z',
    priority: 'high',
    actionUrl: '/account/custom-orders',
    actionLabel: 'Reply to Artisan',
    actionView: 'custom_orders',
    emailSent: true
  },
  {
    id: 'notif-init-5',
    ...
    category: 'websites',
    title: 'Couple Sanctuary Subdomain Ready',
    message: 'Subdomain hamza-sarah.harconxs.com is provisioned with 4K photo memory vaults and audio stream.',
    data: { subdomain: 'hamza-sarah' },
    isRead: true,
    readAt: '2026-08-17T11:00:00Z',
    createdAt: '2026-08-17T08:30:00Z',
    priority: 'normal',
    actionUrl: '/account/couple-websites',
    actionLabel: 'Open Studio',
    actionView: 'couple_websites',
    emailSent: true
  },
  {
    id: 'notif-init-6',
    ...
    category: 'security',
    title: 'Developer Token Issued ("Discord Bot Sync")',
    message: 'New API key created (hx_live_89a1...) with permissions: orders.read, webhooks.manage.',
    data: { keyName: 'Discord Bot Sync', keyPrefix: 'hx_live_89a1' },
    isRead: true,
    readAt: '2026-08-18T16:00:00Z',
